...
/*===========================================================================*
 *			Messages for calc server        *
 *===========================================================================*/

#define CALC_MULTIPLY_BASE  0x100

/* Field names for calc requests. */
#define CALC_MULTIPLY              (CALC_MULTIPLY_BASE + 0)
#define CALC_MULTIPLY_MULTIPLICAND m1_i1 /* Multiplication multiplicand. */
#define CALC_MULTIPLY_MULTIPLIER   m1_i2 /* Multiplication multiplier. */
#define CALC_MULTIPLY_PRODUCT      m1_i3 /* Multiplication product. */

#define CALC_ADD_BASE   0x110

/* Field names for calc requests. */
#define CALC_ADD        CALC_ADD_BASE
#define CALC_ADD_AUGEND m1_i1
#define CALC_ADD_ADDEND m1_i2
#define CALC_ADD_SUM    m1_i3
